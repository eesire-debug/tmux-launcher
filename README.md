...
| 🔐 **askpass 免密** | 每台机器单独记密码，连接时自动调用问问 SSH Agent 不存在时的密码 |
...
```bash
# Debian / Ubuntu
sudo apt install python3-gi gir1.2-gtk-3.0 gir1.2-vte-2.91 ptyxis   # 可选
# Fedora
sudo dnf install python3-gobject gtk3 vte291 ptyxis                 # 可选
# Arch
sudo pacman -S python-gobject gtk3 vte3 ptyxis                      # 可选
```
